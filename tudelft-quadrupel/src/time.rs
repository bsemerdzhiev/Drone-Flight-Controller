...
use nrf51_pac::{interrupt, RTC0, RTC1};
...
static RTC: Mutex<OnceCell<Rtc<RTC1>>> = Mutex::new(OnceCell::uninitialized());
...
pub(crate) fn initialize(clock_instance: RTC1, nvic: &mut NVIC) {
    RTC.modify(|rtc| {
